...
{
    public class OpenWeatherMapPluginZurich : WeatherPluginBase
    {
        ...
        private readonly string RootConfig = "OpenWeatherMapPluginZurich";

        public OpenWeatherMapPluginZurich(IPluginConfigProvider pluginConfigProvider)
