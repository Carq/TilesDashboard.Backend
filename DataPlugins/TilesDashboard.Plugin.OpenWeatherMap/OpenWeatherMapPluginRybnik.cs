...
{
    public class OpenWeatherMapPluginRybnik : WeatherPluginBase
    {
        ...
        private readonly string RootConfig = "OpenWeatherMapPluginRybnik";

        public OpenWeatherMapPluginRybnik(IPluginConfigProvider pluginConfigProvider)
