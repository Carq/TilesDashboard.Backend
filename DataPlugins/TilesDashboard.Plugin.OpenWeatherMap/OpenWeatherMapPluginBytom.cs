...
{
    public class OpenWeatherMapPluginBytom : WeatherPluginBase
    {
        ...
        private readonly string RootConfig = "OpenWeatherMapPluginBytom";

        public OpenWeatherMapPluginBytom(IPluginConfigProvider pluginConfigProvider)
